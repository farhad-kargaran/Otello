...
public class Painter {
    ...
    public void drawLine(int startX, int startY,int stopX, int stopY, int color, float lineWidth)
    {
        paint.setColor(color);
        paint.setStrokeWidth(lineWidth);
        canvas.drawLine(startX,startY,stopX,stopY,paint);
    }
    public void drawCircle(int x, int y, int width, int height, float strockWidth, int color) {
