...
public class DeviceInfo
{
    ...
    public static class HardwareInfo
    {
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_NFC))
            {
                return "yes";
            }
            return "no";
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_NFC_HOST_CARD_EMULATION))
            {
                return "yes";
            }
            return "no";
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_WIFI_DIRECT))
            {
                return "yes";
            }
            return "no";
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR1 && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_USB_HOST))
            {
                return "yes";
            }
            return "no";
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR1 && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_USB_ACCESSORY))
            {
                return "yes";
            }
            return "no";
        ...
        public static String getTotalMemory()
        {
            try
            {
                ...
                for (String aListMemory : listMemory)
                {
                    if (aListMemory.contains("MemTotal"))
                        return aListMemory;
                }
            }
            catch (IOException e)
        ...
        public static String getDeviceId(Context context) // return imei
        {
            String uId = null;
            try
            {
                TelephonyManager TelephonyMgr = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
                uId = TelephonyMgr.getDeviceId(); // Requires READ_PHONE_STATE
            }
            catch (Exception e)
            {
                Helper.showErrorMessage("DeviceInfo - > getDeviceId", e);
            }
            return uId;
        }
    }
    ...
    public static class SensorInfo
    {
		...
		{
			SensorManager manager = (SensorManager) SmsApp.getInstance().getSystemService(SmsApp.getInstance().SENSOR_SERVICE);
    ...
    public static class ScreenInfo
    {
        ...
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD && activity.getPackageManager().hasSystemFeature(PackageManager.FEATURE_TOUCHSCREEN_MULTITOUCH_JAZZHAND))
            {
                return "5+ Points";
            }
        ...
        public static String getDensity(Activity activity)
        {
            ...
            if (model.contains("Ascend G300") || model.contains("Nexus S") || model.contains("Lenovo A380"))
            {
                return "High";
            }
        ...
        {
            String model = Build.MODEL;
            if (model.contains("Ascend G300") || model.contains("Nexus S") || model.contains("Lenovo A380") || model.contains("i-mobile i-note WiFi 9"))
            {
                return "800 x 480 px";
            }
        ...
        public static String getDeviceSizeToInches(Activity activity)
        {
            DisplayMetrics dm = new DisplayMetrics();
            ...
            return String.valueOf(df.format(screenInches));
        }

		/*public static double getDeviceScreenSizeToInches()
		{
			android.util.DisplayMetrics dm = SmsApp.getInstance().getResources().getDisplayMetrics();

			double density = dm.density * 160;
			double x = Math.pow(dm.widthPixels / density, 2);
			double y = Math.pow(dm.heightPixels / density, 2);
			double screenInches = Math.sqrt(x + y);
			////android.util.Log.d("inches: {},DPI:", String.valueOf(screenInches)+","+String.valueOf(density));
			return screenInches;
        ...
        //Normal : 3 - 4.5 Inches
        //Large : 4.5 - 7 or 10 Inches
        //Extra-Large : > 7 or 10 Inches
        ...
        {
            DisplayMetrics metrics = App.getInstance().getResources().getDisplayMetrics();
            float          px      = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, metrics.widthPixels, App.getInstance().getResources().getDisplayMetrics());
            return (int) px;
        ...
        {
            DisplayMetrics metrics = App.getInstance().getResources().getDisplayMetrics();
            float          f       = convertPixelsToDp(metrics.heightPixels, App.getInstance());
            return (int) f;
        ...
        public static String getSupportedJpegThumbnailSizes(Parameters params)
        {
            ...
            if (jpegThumbnailSizes != null)
            {
                for (int i = 0; i < jpegThumbnailSizes.size(); i++)
                    str += (i < jpegThumbnailSizes.size() - 1) ? jpegThumbnailSizes.get(i).width + "x" + jpegThumbnailSizes.get(i).height + " " : jpegThumbnailSizes.get(i).width + "x" + jpegThumbnailSizes.get(i).height;
                return str;
            }
            else
            {
        ...
        public static String getSupportedPictureSizes(Parameters params)
        {
            ...
            if (pictureSizes != null)
            {
                for (int i = 0; i < pictureSizes.size(); i++)
                    str += (i < pictureSizes.size() - 1) ? pictureSizes.get(i).width + "x" + pictureSizes.get(i).height + " " : pictureSizes.get(i).width + "x" + pictureSizes.get(i).height;
                return str;
            }
            else
            {
        ...
        public static String getSupportedPreviewSizes(Parameters params)
        {
            ...
            if (previewSizes != null)
            {
                for (int i = 0; i < previewSizes.size(); i++)
                    str += (i < previewSizes.size() - 1) ? previewSizes.get(i).width + "x" + previewSizes.get(i).height + " " : previewSizes.get(i).width + "x" + previewSizes.get(i).height;
                return str;
            }
            else
            {
        ...
        public static String getSupportedPreviewFpsRange(Parameters params)
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD)
            {
                ...
                if (previewFpsRange != null)
                {
                    ...
                    {
                        str += (i < previewFpsRange.size() - 1) ? (float) previewFpsRange.get(i)[0] / 1000 + "-" + (float) previewFpsRange.get(i)[previewFpsRange.get(i).length - 1] / 1000 + " " : (float) previewFpsRange.get(i)[0] / 1000 + "-" + (float) previewFpsRange.get(i)[previewFpsRange.get(i).length - 1] / 1000;
                    }
                    return str;
                }
                else
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)
            {
                ...
                if (videoSizes != null)
                {
                    for (int i = 0; i < videoSizes.size(); i++)
                        str += (i < videoSizes.size() - 1) ? videoSizes.get(i).width + "x" + videoSizes.get(i).height + " " : videoSizes.get(i).width + "x" + videoSizes.get(i).height;
                    return str;
                }
                else
                {
